...
rsync -vhcP -e ssh $file arkonn@frs.sourceforge.net:/home/frs/project/arkonn/$device/
echo "Download link https://sourceforge.net/projects/arkonn/files/$device/$dlink/download"
